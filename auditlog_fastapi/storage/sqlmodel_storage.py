...
class SQLModelStorage(AuditStorage):
    ...
    async def startup(self) -> None:
        try:
            ...
            self.AuditLog = make_sqlmodel_table(self.config.table_name)
            ...
            raise AuditStorageConnectionError(
                f"Failed to connect to SQLModel backend: {e}"
            ) from e
